...
from sqlalchemy import String, Integer, SmallInteger, DateTime, Date, ForeignKey, Text
...
class Prescription(Base):
    ...
    RECETE_TARIHI: Mapped[datetime] = mapped_column(
        ...
        DateTime,
        nullable=False,
        comment="Prescription date and time"
    )
    ...
    HEKIM: Mapped[Optional[int]] = mapped_column(
        ...
        Integer,
        nullable=True,
        comment="Prescribing physician ID"
    )
    ...
    DURUM: Mapped[int] = mapped_column(
        ...
        nullable=False,
        default=1,
        comment="Status (1=Active, 2=Cancelled, etc.)"
    )
    ...
    ACIKLAMA: Mapped[Optional[str]] = mapped_column(
        ...
        Text,
        nullable=True,
        comment="Prescription notes/instructions"
    )
    ...
    ESY_RECETE_NO: Mapped[Optional[str]] = mapped_column(
        ...
        String(50),
        nullable=True,
        comment="E-Health System prescription number"
    )
    ...
    ESKI_RECETE_ID: Mapped[Optional[int]] = mapped_column(
        ...
        Integer,
        nullable=True,
        comment="Old prescription ID (for migration)"
    )
...
class Diagnosis(Base):
    ...
    TANI_TURU: Mapped[Optional[int]] = mapped_column(
        ...
        Integer,
        nullable=True,
        comment="Diagnosis type (primary/secondary/etc.)"
    )
    ...
    TANI_ACIKLAMA: Mapped[Optional[str]] = mapped_column(
        ...
        Text,
        nullable=True,
        comment="Diagnosis description/notes"
    )
    ...
    DURUM: Mapped[int] = mapped_column(
        ...
        nullable=False,
        default=1,
        comment="Status (1=Active, 2=Resolved, etc.)"
    )
