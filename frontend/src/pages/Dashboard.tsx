        ...
        <div className="card">
          ...
          <div className="card-body space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium ${statusColor(databaseStatus)}`}
              >
                {databaseStatus}
              </span>
            </div>
            <div className="flex justify-between items-center">
              ...
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium ${statusColor(aiStatus)}`}
              >
                {aiStatus}
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="card hover:shadow-lg transition-shadow">
          <div className="card-body text-center">
            ...
            <p className="text-sm text-gray-600">
              Search and view patient medical history, lab results, and
              treatment records
            </p>
          </div>
        </div>
        ...
        <div className="card hover:shadow-lg transition-shadow">
          <div className="card-body text-center">
            ...
            <p className="text-sm text-gray-600">
              Generate differential diagnoses using advanced AI models with
              probability scoring
            </p>
          </div>
        </div>
