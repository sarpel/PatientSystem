    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header">
          <h2 className="text-lg font-semibold text-gray-900">AI-Powered Differential Diagnosis</h2>
        </div>
                  ...
                  <tbody>
                    {result.differential_diagnosis.map((dx, index) => (
                      <tr key={index}>
                        ...
                        <td className={`font-semibold ${getProbabilityColor(dx.probability)}`}>
                          {(dx.probability * 100).toFixed(1)}%
                        </td>
                        <td>
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${getSeverityColor(dx.urgency)}`}>
